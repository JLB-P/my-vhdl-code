...
HD_PWD='C:/repo/my-vhdl-code/arithmetic_system/arithmetic_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arithmetic_system_top.tcl -notrace
